...
<body>
  ...
  <header id="header" class="fixed-top">
    <div class="container d-flex align-items-center">
      ...
      <h1 class="logo mr-auto"><a href="index.html">NadiWarga<span>.</span></a></h1>
  ...
  <footer id="footer">
    <div class="container py-4">
      <div class="copyright">
        &copy; Copyright <strong><span>PT.Nadi Nusantara Teknologi</span></strong>. All Rights Reserved
      </div>
      <div class="credits">
        Designed by <a href="#">PT.Nadi Nusantara Teknologi</a>
      </div>
    </div>
  </footer><!-- End Footer -->
