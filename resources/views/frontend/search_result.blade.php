...
<body>
  ...
  <header id="header" class="fixed-top">
    <div class="container d-flex align-items-center">
      ...
      <h1 class="logo mr-auto"><a href="{{url('/')}}">NadiWarga<span>.</span></a></h1>
 ...
 <section id="hero" class="d-flex align-items-center">
  ...
  <footer id="footer">
    <div class="container py-4">
      <div class="copyright">
        &copy; <span data-translate="footer.copyright">Copyright</span> <strong><span>PT.Nadi Nusantara Teknologi</span></strong>. <span data-translate="footer.rights">All Rights Reserved</span>
      </div>
      <div class="credits">
        <span data-translate="footer.designed">Designed by</span> <a href="#">PT.Nadi Nusantara Teknologi</a>
      </div>
    </div>
  </footer><!-- End Footer -->
