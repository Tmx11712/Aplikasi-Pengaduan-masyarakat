                    ...
                    <div class="d-flex">
                        <div class="navbar-brand-box">
                            <a href="index.html" class="logo logo-dark">
                                ...
                                <span class="logo-lg">
                                    <img src="{{asset('assets/images/logo-putih.png')}}" alt="" height="100">
                                </span>
                            </a>
                            ...
                            <a href="{{url('user/home')}}" class="logo logo-light">
                                ...
                                <span class="logo-lg">
                                    <img src="{{asset('assets/images/logo-putih.png')}}" alt="" height="150">
                                </span>
                            </a>
                        </div>
               ...
               @yield('content')
                <footer class="footer">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-sm-6">
                                <script>document.write(new Date().getFullYear())</script> © Nadiwarga.
                            </div>
                            <div class="col-sm-6">
                                <div class="text-sm-end d-none d-sm-block">
                                    Design & Develop by PT.Nadi Nusantara Teknologi
                                </div>
                            </div>
                        </div>
                    </div>
